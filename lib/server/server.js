...
// Load .env into process.env before any config is read (e.g. for PM2 / npm start)
...
///////////////////////////////////////////////////
// Start the Diabetes-M -> Nightscout Python sync scheduler
///////////////////////////////////////////////////
// This will periodically run dm2nsc/index.py while the Node app is running.
// Controlled via DM2NSC_CRON / DM2NSC_PYTHON / DM2NSC_TZ env vars.
try {
  require('../../dm2nsc/runPyJob');
} catch (e) {
  // If the dm2nsc helper is missing, don't crash the main server.
  console.error('Failed to start dm2nsc Python scheduler:', e.message);
}
